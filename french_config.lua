...
--TEMP
L["A taint has occured that is preventing you from using the queue system. Please reload your user interface and try again."] = 

--ActionBars
L[" |cff00ff00bound to |r"] =
...
L['Confused.. Try Again!'] = 
L["copperabbrev"] = 
L['Currency Format'] = "Format monétaire"
L["Delete Grays"] = 
L["Deleted %d gray items. Total Worth: %s"] = 
...
L['Classic'] = 
L["Click the button below to resize your chat frames, unitframes, and reposition your actionbars."] = 
L['Config Mode:'] = 
L["CVars Set"] = 
L["CVars"] = 
L['Dark'] = 
...
L["Select the type of aura system you want to use with ElvUI's unitframes. The integrated system utilizes both aura-bars and aura-icons. The icons only system will display only icons and aurabars won't be used. The classic system will configure your auras to be default."] = 
L["Setup Chat"] = 
L["Setup CVars"] = 
L["Skip Process"] = 
L["Sticky Frames"] = 
...
L['The Pixel Perfect option will change the overall apperance of your UI. Using Pixel Perfect is a slight performance increase over the traditional layout.'] = 
L['Theme Set'] = 
L['Theme Setup'] = 
...
L["This resolution doesn't require that you change settings for the UI to fit on your screen."] = 
L["This resolution requires that you change some settings to get everything to fit on your screen."] = 
L["This will change the layout of your unitframes, raidframes, and datatexts."] = 
L["Toggle Anchors"] = "Afficher les ancres"
L['Toggle Configuration'] = 
...
L['Using this option will cause your borders around frames to be 1 pixel wide instead of 3 pixel. You may have to finish the installation to notice a differance. By default this is enabled.'] = 
L["Version"] = "Version"
...
L["You may need to further alter these settings depending how low you resolution is."] = 
...
L['Galleon'] = 
L['Gates Destroyed'] = 
L['Graveyards Assaulted'] = 
L['Graveyards Defended'] = 
L["Hands"] = 
L["Head"] = 
L["Hit"] = 
L["Home Latency:"] = 
...
L["Panels"] = "Fenêtre"
L["Profit:"] = 
L["Reset Data: Hold Shift + Right Click"] = 
L["right"] = "Droite"
...
L["Your version of ElvUI is out of date. You can download the latest version from http://www.tukui.org"] = 
...
L['The initial group will start near the center and grow out. Corrosponding groups will behave normally.'] = "Le premier groupe commence à proximité du centre et s'en développe hors. Les groupes correspondants se comporteraont normalement" --Nedd review
