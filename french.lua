...
L["Auras Frame"] = "Fenetre des auras";
...
L["GM Ticket Frame"] = "Fenetre du ticket MJ";
L["Left Chat"] = "Chat de gauche"
L["Loot / Alert Frames"] = "Butin/fenetre d'alerte";
L["Loot Frame"] = "fenetre du butin";
L["Loss Control Icon"] = "Icone de la perte de controle";
L["MA Frames"] = "Fenetre du second tank";

L["Micro Bar"] = "Micro Barre" --Also in ActionBars
L["MT Frames"] = "Fenetre du tank";
...
L["Totems"] = "Totems";
L["Vehicle Seat Frame"] = "Fenetre de l'assise du vehicule";
L["Watch Frame"] = "Fenetre de la Montre";
L["Weapons"] = "Armes";

--NamePlates
L["Add Name"] = "Ajouter un nom"
L["Adjust nameplate size on smaller mobs to scale down. This will only adjust the health bar width not the actual nameplate hitbox you click on."] = "Ajuster la taille nominale d'echelle des noms d'unités vers le bas des petits mobs.Cela n'ajustera que la largeur de la barre de vie pas l actuel hitbox de la barre de vie que l'on clique";
L["All"] = "Tout"
L['Aura'] = "Aura";
L["Auras"] = "Auras"
...
L["Class Icons"] = "Icone de la classe";
...
L["Display a class icon on nameplates."] = "Affiche l'icone de classe sur l'unité";
L["Display a healer icon over known healers inside battlegrounds or arenas."] = "Affiche l'icone de soigneur sur le soigneur connu à l'interieur d'un champ de bataille ou arène";
L["Display combo points on nameplates."] = "Affiche les points de combos sur l'unité";
...
L['Display the health text on the tooltip.'] = "Affiche la santé en texte sur l'info-bulle";
...
L['Set the height of the tooltip healthbar.'] = "regle la hauteur de la barre de vie de l'info-bulle";
...
L["Block Non-Whitelisted Auras"] = "Bloquer les Auras non liste-blanche";
