...
L["Class Icons"] = "职业图标"
L["Color of a nameplate that is tagged by another person."] = "战斗中, 被其他玩家设为目标的血条颜色."
L["Color Tanked/Loose"] = "获得/失去最高仇恨"
L['Color the border of the nameplate yellow when it reaches the threshold point on these types of frames.'] = "当到达此阈值数值时, 血条的边框将被上色为黄色."
...
L["Controls the height of the nameplate's castbar"] = "血条施法条的高度设定"
L["Controls the width of the nameplate"] = "血条的宽度设定"
L["Custom Color"] = "自定颜色"
L["Custom Scale"] = "自定大小比例"
L["Depending on your role. If you are a tank then it will color mobs being tanked by the offtank. If you are not a tank then it will color mobs not being tanked. This is not 100% accurate and should only be used as a referance."] = "若做为坦克, 当怪物的最高仇恨由另一名坦克获得, 或不作为坦克, 没有被坦克获得最高仇恨的怪物血条将改变颜色. 这并不是100%准确, 只能作为参考."
L["Depending on your role. If you are a tank then its the color of mobs being tanked not by you by an actual tank. If you are not a tank then it is the color of mobs that are not currently being tanked."] = "若做为坦克, 怪物的最高仇恨不是由你获得, 或不作为坦克, 怪物最高仇恨没有被坦克获得时血条显示的颜色."
L["Disable threat coloring for this plate and use the custom color."] = "对特定的目标停用仇恨颜色,并使用定制颜色"
L["Display a class icon on nameplates."] = "在血条上显示职业图标."
...
L['Name Alignment'] = "姓名对齐"
L["Name X-Offset"] = "姓名X轴偏移"
L["Name Y-Offset"] = "姓名Y轴偏移"
L["NamePlates"] = "姓名面板(血条)"
L["Personal Auras"] = "个人光环"
L['Players'] = "玩家"
L["Prevent any nameplate with this unit name from showing."] = "不显示特定目标的血条"
L["Remove Name"] = "删除筛选名"
L["Select a filter to use. These are imported from the unitframe aura filter."] = "选择一个过滤器使用. 这些从单位框架的光环过滤器中输入"
L["Set the scale of the nameplate."] = "设定血条的缩放比例"
L["Small Plates"] = "小型模板"
L["Tagged Color"] = "被设为目标色"
L["Tanked/Loose Color"] = "获得/失去最高仇恨色"
L['The backdrop of the nameplates color is scaled to match the color of the nameplate by this percentage. Set to zero to have no color in the nameplate backdrop.'] = "血条背景色透明度, 设为0时血条背景没有颜色(黑色)"
...
L['Color castbars by the class or reaction type of the unit.'] = "以职业色显示施法条."
...
L['Raid Icon'] = "团队图标"
L['Raid-10 Frames'] = "10人团队框架"
L['Raid-25 Frames'] = "25人团队框架"
...
L['Reverses the grouping order. For example if your group is to grow right than up by default the first group is always at the bottom. With this option set then the first group will start at the bottom but as the number of groups grow it will always be near the top.'] = "反转队伍排序. 例如: 默认情况下,如果你的增长方向是'右上', 第一队是在底部的. 使用此选项设置, 则第一队开始在底部, 但增长的队伍永远从第一队的底部开始."
...
L["Target units on mouse down rather than mouse up. \n\n|cffFF0000Warning: If you are using the addon 'Clique' you may have to adjust your clique settings when changing this."] = t"按下鼠标时设为目标,而不是松开鼠标按键时. \n\n|cffFF0000警告: 如果使用'Clique'等点击施法插件, 你可能需要调整这些插件的设置."
L['Text Color'] = "文字颜色"
L["Text Format"] = "文字格式"
...
L['The initial group will start near the center and grow out. Corrosponding groups will behave normally.'] = "最初的队伍由中心开始增长. 相应的队伍将正常工作."
