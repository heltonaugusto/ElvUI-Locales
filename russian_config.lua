...
L["You have changed the pixel perfect option. You will have to complete the installation process to remove any graphical bugs."] = 
...
L["Are you sure you want to delete all your gray items?"] = 
...
L['The initial group will start near the center and grow out. Corrosponding groups will behave normally.'] = "Первая группа появится в центре и будет расти наружу. Остальные группы будут вести себя нормально."
