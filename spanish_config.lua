...
L['Nudge'] = 'Ajuste Fino'; -- Best translation I could come up with
...
L["Adjust nameplate size on smaller mobs to scale down. This will only adjust the health bar width not the actual nameplate hitbox you click on."] = 'Ajusta el tamaño de la placa de nombre de los enemigos pequeños. Esto sólo ajusta el ancho de la barra de vida, no el tamaño de la caja de contacto donde haces clic.'; -- Best translation I could think of for "hitbox".
L["All"] = "Todo";
...
L["Color of a nameplate that is tagged by another person."] = 'Color de la placa de nombre tocada por otra persona.';
L["Color Tanked/Loose"] = 'Colorear Tanqueados/Sueltos'; -- Anyone has a better translation for "tanked"?
...
L["Depending on your role. If you are a tank then it will color mobs being tanked by the offtank. If you are not a tank then it will color mobs not being tanked. This is not 100% accurate and should only be used as a referance."] = 'Depende de tu rol. Si eres un tanque coloreará los enemigos que sean tanqueados por el tanque secundario. Si no eres un tanque entonces coloreará los enemigos que no estén siendo tanqueados. Esto no es 100% preciso y sólo debe usarse como referencia.';
L["Depending on your role. If you are a tank then its the color of mobs being tanked not by you by an actual tank. If you are not a tank then it is the color of mobs that are not currently being tanked."] = 'Depende de tu rol. Si eres un tanque es el color de los enemigos que son tanqueados por otro tanque, no tú. Si no eres un tanque entonces es el color de los enemigos que no están siendo tanqueados.';
...
L["Display a class icon on nameplates."] = 'Muestra un icono de clase en las placas de nombre';
...
L['Name Alignment'] = 'Alineación del Nombre';
...
L["Tagged Color"] = 'Color de Tocado';
L["Tanked/Loose Color"] = 'Color de Tanqueado/Suelto';
...
L['Display the health text on the tooltip.'] = 'Muestra el texto de salud en la descripción emergente';
...
L['Health Height'] = 'Altura de la Barra de Salud';
...
L['Set the height of the tooltip healthbar.'] = 'Establece la altura de la barra de salud';
...
L['Color castbars by the class or reaction type of the unit.'] = 'Colorea las barras de lanzamiento por clase o tipo de reacción de la unidad.';
...
L['Mouseover'] = 'Pasar el ratón por encima'; -- A bit long, huh?
L['Name (Entire Group)'] = 'Nombre (Grupo Entero)';
...
L['Reverses the grouping order. For example if your group is to grow right than up by default the first group is always at the bottom. With this option set then the first group will start at the bottom but as the number of groups grow it will always be near the top.'] = 'Invierte el orden de agrupación. Por ejemplo, si tu grupo crece a la derecha en lugar de arriba el primer grupo está abajo. Con esta opción activada el primer grupo comenzará abajo pero a medida que el número de grupos crezca éstos estarán por debajo del primero.';
...
L['The initial group will start near the center and grow out. Corrosponding groups will behave normally.'] = 'El grupo inicial comenzará cerca del centro y crecer. Los grupos correspodientes se comportarán de forma normal.';
