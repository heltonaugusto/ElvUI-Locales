...
L['The backdrop of the nameplates color is scaled to match the color of the nameplate by this percentage. Set to zero to have no color in the nameplate backdrop.'] = "La couleur de fond du cadres d'unité est redimensionnée pour correspondre à la couleur de la plaque signalétique de ce pourcentage. Mis à zéro pour ne pas avoir de couleur dans la couleur de fond la plaque."
...
L['Player Frame Aura Bars'] = "Aura barre du cadre joueur"
...
L["Sets the font instance's horizontal text alignment style."] = "Reglages de l'alignement horizontal du texte de la police d'écriture"
