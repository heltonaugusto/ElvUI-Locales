...
L['Ignore Items'] = "Items ignorés";
L['List of items to ignore when sorting. If you wish to add multiple items you must seperate the word with a comma.'] = "Liste des éléments à ignorer pendant le tri. Si vous souhaitez ajouter plusieurs articles, vous devez séparer les mots par une virgule.";
...
L["Panels"] = "Fenêtre"
L["Profit:"] = "Profit:"
L["Reset Data: Hold Shift + Right Click"] = "Réinitialiser les données: Shift + Clic droit"
L["right"] = "Droite"
...
--Distributor
L['%s is attempting to share his filters with you. Would you like to accept the request?'] = "%s tente de partager ses profils avec vous. Aimeriez-vous accepter la requete?" ;
L['%s is attempting to share the profile %s with you. Would you like to accept the request?'] = "%s est en attente pour partager le profil de %s.Aimeriez-vous accpeter la requete?";
L["Data From: %s"] = "Donnée de: %s";
L['Filter download complete from %s, would you like to apply changes now?'] = "Telechargement du filtre de %s est complet, aimeriez-vous appliquer les changements maintenant?'";
L["Lord! It's a miracle! The download up and vanished like a fart in the wind! Try Again!"] = "Seigneur! C'est un miracle! Le telechargement est bon et a disparut comme une pet dans le vent! Essayez encore !"  --try  gain to fart ? lol 
L["Must be in group with the player if he isn't on the same server as you."] = "Doit etre dans le meme groupe avec le joueur,s'il n'est pas du meme serveur";
L['Profile download complete from %s, but the profile %s already exists. Change the name or else it will overwrite the existing profile.'] = "Telechargement du profil de %s est complet, mais le profil de % existe déjà. Changez le nom ou autre écrasera le profil existant";
L['Profile download complete from %s, would you like to load the profile %s now?'] = "Telechargement du profil de %s est complet, aimeriez-vous charger le profil de %s maintenant?'";
L['Profile request sent. Waiting for response from player.'] = "Requete du profil envoyé. Attente de la reponse du joueur' ";
L['Request was denied by user.'] = "Requete a ete refusée par l'utilisateur";
L["Sends your current profile to your target."] = "Envoie votre profil actuel à votre cible";
L["Sends your filter settings to your target."] = "Envoie votre reglage du filtre à votre cible";
L["Share Current Profile"] = "Partagez votre profil actuel";
L["Share Filters"] = "Partagez les filtres";
L["This feature will allow you to transfer, settings to other characters."] = "Cette fonctionnalité vous permettra de transférer les parametres à d'autres personnages";
L["You must be targeting a player."] = "Vous devez cibler un joueur";
L['Your profile was successfully recieved by the player.'] = "Votre profil a été recu avec succès par le joueur";
...
L["All"] = "Tout"
L["Always display your personal auras over the nameplate."] = "Toujours afficher vos auras personnelles au-dessus de votre unité";
L['Aura'] = "Aura";
L["Auras"] = "Auras"
...
L["Color of a nameplate that is tagged by another person."] = "Couleur de la barre de vie marquée par un autre perso";
...
L["Depending on your role. If you are a tank then it will color mobs being tanked by the offtank. If you are not a tank then it will color mobs not being tanked. This is not 100% accurate and should only be used as a referance."] = "En fonction de votre rôle.Si vous êtes un tank alors il va colorer les monstres tankés par l'offtank.Si vous n'êtes pas un tank alors il va colorer les monstres qui ne sont pas tankés.Ce n'est pas précis à 100% et ne devrait être utilisé comme referance.";
L["Depending on your role. If you are a tank then its the color of mobs being tanked not by you by an actual tank. If you are not a tank then it is the color of mobs that are not currently being tanked."] = "En fonction de votre rôle.Si vous etes le tank alors c'est la couleur du mob tanké non pas par vous mais par le tank actuel.Si vous n'etes pas le tank alors alors c'est la couleur des mobs qui ne sont pas actuellement tankés." ;
...
L["Tagged Color"] = "Couleur Marquée";
...
L['Display the health text on the tooltip.'] = "Affiche textuellement la santé dans l'info-bulle";
...
L['Health Height'] = "Hauteur de la barre de vie";
...
L['Set the height of the tooltip healthbar.'] = "Règle la hauteur de la barre de vie de l'info-bulle";
...
L["Who's targeting who?"] = "Qui cible qui ?"
...
L['At what point should the text be displayed. Set to -1 to disable.'] = "Sur quel point le texte devrait etre affiché. Reglage à -1 pour desactiver";
...
L['Center'] = "Centrer";
L["Check if you are in range to cast spells on this specific unit."] = "Vérifie si vous êtes à portée de sort sur cette unité specifique";
...
L["Color all buffs that reduce the unit's incoming damage."] = "Colorer tous les buffs qui permettent de réduire les dégâts reçus de l'unité";
...
L['Color Turtle Buffs'] = "Couleur de l' amelioration de la tortue"; --wtf ?....you mean....turtle yuma ? need reviews or precisions....traducted like as see..sorry...
L["Color"] = "Couleur"
...
L["Count Font Size"] = "Taille du  texte du  decompte" -- is  it count  when entering in the BattleGround? ;
...
L['Display Text'] = "Affichage du  texte";
...
L["Don't display auras that cannot be purged or dispelled by your class."] = "Ne pas afficher les auras qui ne sont pas purgés ou dispellés par votre classe" ;
L["Don't display auras that have no duration."] = "Ne pas afficher les auras qui n'ont pas de durée";
L["Don't display raid buffs such as Blessing of Kings or Mark of the Wild."] = "Ne pas afficher les Ameliorations de raid comme la bénédictions des Rois ou La Marque du Fauve";
L["Down"] = "En bas"
...
L['Health Border'] = "Bordure de la santé personnalisé";
...
L["Icon"] = "Icône"
L['Icon: BOTTOM'] = "Icone: BAS";
L['Icon: BOTTOMLEFT'] = "Icone: BAS-GAUCHE";
L['Icon: BOTTOMRIGHT'] = "Icone: BAS-DROITE";
L['Icon: LEFT'] = "Icone: GAUCHE";
L['Icon: RIGHT'] = "Icone: DROITE";
L['Icon: TOP'] = "Icone: HAUT";
L['Icon: TOPLEFT'] = "Icone: HAUT-GAUCHE";
L['Icon: TOPRIGHT'] = "Icone: HAUT-DROITE"
L["If no other filter options are being used then it will block anything not on the 'Whitelist' filter, otherwise it will simply add auras on the whitelist in addition to any other filter settings."] = "S'il n'y a pas d'autres options de filtres utilisés alors il bloquera quoi que ce soit sur la 'ListeBlanche' du filtre,sinon il suffira d'ajouter les auras sur la liste blanche en plus de tous les autres parametres du filtre.";
...
L["If the unit is friendly to you."] = "Si l'unité est  amicale";
...
L['Make textures transparent.'] = "Faire des texttures Transparentes";
...
L['Offset position for text.'] = "Decalage de la position du texte";
L["Offset"] = "Décalage"
L['Only show when the unit is not in range.'] = "Montre seulement quand l'unité est hors de portée"
L['Only show when you are mousing over a frame.'] = "Montre seulement quand vous survolez une fenetre à la souris" ;
...
L["Portrait"] = "Portrait"
L['Position Override'] = "Force la position"
L["Position"] = "Position"
...
L['Select an additional filter to use. If the selected filter is a whitelist and no other filters are being used (with the exception of Block Non-Personal Auras) then it will block anything not on the whitelist, otherwise it will simply add auras on the whitelist in addition to any other filter settings.'] =  "Selectionne un filtre addionnel à utiliser. Si le filtre sélectionné est une liste blanche et aucun autres filtres sont utilisés (à l'exception du bloc des Auras Non-Personnels) alors il bloquera quoi que ce soit qui n'est pas dans la liste blanche, sinon il suffira d'ajouter les auras dans la liste blanche,en plus de tous les autres parametres de filtre.";
...
L['Spells'] = "Sorts";
L['Stagger Bar'] = "Barre de Report" --  not definitive
...
L["Target On Mouse-Down"] =  "Cible Sur Sourie-Bas";
L["Target units on mouse down rather than mouse up. \n\n|cffFF0000Warning: If you are using the addon 'Clique' you may have to adjust your clique settings when changing this."] = "Cible l'unité avec la sourie vers le bas plutot que vers le haut. \n\n|cffFF0000Attention: Si vous utlisez l'addon 'Clique' vous devriez peut-être ajuster vos paramètres de Cliques pendant les changements."
...
L['This will determine how the party/raid group will grow out when the group is not full. For example setting this to BOTTOMLEFT would cause the first raid frame to spawn from the BOTTOMLEFT corner of where the mover is positioned.'] = "Ceci determinera comment le groupe groupe/raid se devellopera quand le groupe n'est pas complet.Par exemple ,regler ceci sur BASGAUCHE affecterait à la fenetre premier raid à se developper à partir du coin BASGAUCHE, là où l'ancreur est  positionné."
...
L['Turtle Color'] = "Couleur tortue" --wtf ? ;
L['Unholy'] = "Sacré";
...
L["What each frame should attach itself to. For example setting it to TOP every unit will attach its top to the last point bottom."] = "Le point d'ancrage pour attacher les cadres entre eux, exemple: si le paramètre est sur HAUT, tous les cadres d'unité se développeront à partir du point vers le bas.";
