...
L['Display data panels below the chat, used for datatexts.'] = "在對話框下顯示用於資訊的框體."
...
L["Group By"] = "隊伍排列方式"
L['Group Size'] = "隊伍尺寸"
L['Growth direction from the first unitframe.'] = "增長方向從第一個頭像框體開始."
...
L['Middle clicking the unit frame will cause your focus to match the unit.'] = "鼠標中鍵點擊單位框體設置焦點."
