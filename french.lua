...
L["Pixel Perfect Set"] = "Reglage Pixel Parfait";
...
L["Select the type of aura system you want to use with ElvUI's unitframes. The integrated system utilizes both aura-bars and aura-icons. The icons only system will display only icons and aurabars won't be used. The classic system will configure your auras to be default."] = "Sélectionnez le type de système aura que vous souhaitez utiliser avec UnitFrames ElvUI. Le système intégré utilise à la fois Aura-bars et Aura-icônes.Le systeme icones seul va afficher uniquement les icônes et aurabars ne sera pas utilisé. Le système classique permet de configurer vos auras à défaut.";
...
L["Server: "] = "Serveur: "
L["Session:"] = "Session: "
L['Sha of Anger'] = "Sha de la colere";
L["Shoulder"] = "Épaule"
...
L['Item Upgrade'] = "Mise a niveau item";
...
L['Player Frame Aura Bars'] = "Fenetre de la barre d'aura du joueur"
...
L['Text'] = "Texte";
L['Textured Icon'] = "Texte de l'icone";
