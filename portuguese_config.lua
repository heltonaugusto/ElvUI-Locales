...
L["This setting will be updated upon changing stances."] = "Essa configuração atualizará ao trocar instâncias.";
...
L["Color of a nameplate that is tagged by another person."] = "Muda a cor de uma placa de identificação que está bloqueada por outra pessoa."
L["Color Tanked/Loose"] = "Cor para Tancado/Solto"
...
L["Depending on your role. If you are a tank then it will color mobs being tanked by the offtank. If you are not a tank then it will color mobs not being tanked. This is not 100% accurate and should only be used as a referance."] = "Depende da sua função. Se você é um tanque então a cor dos inimigos que estão sendo tancados pelo tanque secundário. Se não é um tanque então é a cor dos inimigos que não estão sendo tancados. Não é 100% preciso e deve ser usadao somente como referência."
L["Depending on your role. If you are a tank then its the color of mobs being tanked not by you by an actual tank. If you are not a tank then it is the color of mobs that are not currently being tanked."] = "Depende da sua função. Se você é um tanque então a cor dos inimigos que estão sendo tancados por outra tanque. Se não é um tanque então é a cor dos inimigos que não estão sendo tancados."
...
L["Name Alignment"] = "Alinhamento do Nome"
L["Name X-Offset"] = "Distância X do Nome"
L["Name Y-Offset"] = "Distância Y do Nome"
...
L["Select a filter to use. These are imported from the unitframe aura filter."] = "Selecione um Filtro para usar. Estes são importados do filtro de auras dos quadros de unidades"
L["Set the scale of the nameplate."] = "Define a escala de placa de identificação."
L["Small Plates"] = "Placas Pequenas"
L["Tagged Color"] = "Cor de Bloquado"
L["Tanked/Loose Color"] = "Cor de Tancado/Solto"
...
L["Color castbars by the class or reaction type of the unit."] = "Colorir as basrras de lançamento pela classe ou tipo de reação da unidade."
...
L["Name (Entire Group)"] = "Nome (Todo o Grupo)"
L["Name"] = "Nome"
L["Neutral"] = "Neutro"
...
L["Reverses the grouping order. For example if your group is to grow right than up by default the first group is always at the bottom. With this option set then the first group will start at the bottom but as the number of groups grow it will always be near the top."] = "Inverte a ordem do grupo. Por exemplo se seu grupo está para crescer da direita para cima então por padrão o primeiro grupo estará sembre na base. Com esta opção definida o primeiro grupo começará na base mas a medida que mais grupos forem criados ele ficará sempre perto do topo."
...
L["The initial group will start near the center and grow out. Corrosponding groups will behave normally."] = "O grupo inicial começara perto do centro e crescerá para fora. Grupos correspondentes se corportarão normalmente."
