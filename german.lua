...
L['Tab Panel Transparency'] = 'Tab Panel Transparenz'
...
L["Color of a nameplate that is tagged by another person."] = "Farbe einer Namensplakette wenn sie von einer anderen Person angeschlagen ist."
L["Color Tanked/Loose"] = "Tankend Farbe/Verloren"
...
L['Color castbars by the class or reaction type of the unit.'] = 'Färbe Zauberleisten nach Klassenfarbe oder Reaktion der Einheit.'
...
L["Count Font Size"] = "Zähler Schriftgröße"
...
L['Middle Click - Set Focus'] = 'Mittel Klick - Setze Fokus'
L['Middle clicking the unit frame will cause your focus to match the unit.'] = 'Mittel Klicken auf das Einheiten Fenster wird den Fokus des Ziels setzen.'
...
L["Portrait"] = "Portrait"
L['Position Override'] = 'Position überschreiben'
L["Position"] = "Position"
