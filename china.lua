...
L["Display a healer icon over known healers inside battlegrounds or arenas."] = "战场或竞技场中，为已确认为治疗的玩家标上补职图示."
...
L["Display the target of the cast on the castbar."] = "在施法条上显示其目标"
