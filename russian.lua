...
L["Color mobs that are currently being tanked. If you are a tank then this will only happen to nameplates being tanked by someone other than you. This is not 100% accurate and should only be used as a referance."] = "Окрашивать индикатор танкуемого юнита. Если Вы танк, то этот цвет будет применяться только на индикатоах юнитов, танкуемых кем-то еще. Точность не 100% и должно восприниматься только как рекомендация."
L["Color of a nameplate that is currently being tanked by another tank in the group."] = "Цвет иникатора юнита, которого держит другой танк в группе."
...
L["Tanked Color"] = "Цвет танкуеиого"
