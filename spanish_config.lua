...
L["Color Tanked/Loose"] = "Colorear Tanqueados/Sueltos"
...
L["Select a filter to use. These are imported from the unitframe aura filter."] = "Selecciona el filtro a usar. Esos son importados desde el filtro del marco de unidad."
